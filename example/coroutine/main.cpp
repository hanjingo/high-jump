...
int main(int argc, char* argv[])
{
    ...
    std::cout << "\ncoroutine send msg to main by lambda example >>" << std::endl;
    libcpp::coroutine<int>::pull_type co_2([](libcpp::coroutine<int>::push_type & out) {
        out(1);
        out(2);
        out(3);
    });
    ...
    std::cout << "\nmain send msg to coroutine by lambda example >>" << std::endl;
    libcpp::coroutine<int>::push_type co_3([](libcpp::coroutine<int>::pull_type & in) {
    ...
    libcpp::coroutine<int>::push_type co_4([](libcpp::coroutine<int>::pull_type & in) {
    ...
    libcpp::coroutine<int>::push_type co_5([](libcpp::coroutine<int>::pull_type & in) {
        for (auto e : in) {
