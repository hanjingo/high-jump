...
int main(int argc, char* argv[])
{
    ...
    // auto ret1 = libcpp::des::ecb::encode(std::string("hello world"),
    // std::string("12345678"), str_encode_dst); std::cout << "ret1=" << ret1 <<
    // std::endl;
    ...
    // auto ret2 = libcpp::des::ecb::encode(std::string("hello world"), str_key,
    // str_encoded); auto ret3 = libcpp::des::ecb::decode(str_encoded, str_key,
    // str_decode_dst); std::cout << "ret2=" << ret2 << ", ret3=" << ret3 << ",
    // str_decode_dst=" << str_decode_dst << std::endl;
