...
int main(int argc, char* argv[])
{
    ...
    if (it_id != id_index.end()) {
        std::cout << "ID=2: " << it_id->name << ", Score: " << it_id->score << std::endl;
    }
    ...
    for (auto it = range.first; it != range.second; ++it) {
        std::cout << "Alice: ID=" << it->id << ", Score=" << it->score << std::endl;
    }
