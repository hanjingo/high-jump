...
{
  public:
    void static StaticSay() { std::cout << "static say" << std::endl; }
    void Say() { std::cout << "say " << name_ << std::endl; }
...
{
    std::cout << "singleton<A>::get_const_instance().StaticSay() >> "
              << std::endl;
    libcpp::singleton<A>::get_const_instance().StaticSay();

    std::cout << "\nSingleton<A>::get_mutable_instance().Say() >> "
              << std::endl;
