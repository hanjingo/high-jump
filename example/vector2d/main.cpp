...
void itr_example()
{
    ...
    std::cout << "((itr + 1) == (itr + 1)) = " << ((itr + 1) == (itr + 1))
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "itr->distance(itr + 1) = " << itr.distance(itr + 1)
              << std::endl;
    std::cout << "itr->distance(itr + 4) = " << itr.distance(itr + 4)
              << std::endl;
    std::cout << "itr->distance(itr + 6) = " << itr.distance(itr + 6)
              << std::endl;
    std::cout << "(itr + 1).distance(itr) = " << (itr + 1).distance(itr)
              << std::endl;
    std::cout << "(itr + 4).distance(itr) = " << (itr + 4).distance(itr)
              << std::endl;
    std::cout << "(itr + 6).distance(itr) = " << (itr + 6).distance(itr)
              << std::endl;
    std::cout << std::endl;
}
...
void row_itr_example()
{
    ...
    std::cout << "((vitr + 1) == (vitr + 1)) = " << ((vitr + 1) == (vitr + 1))
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "*vitr = " << *vitr << std::endl;
    std::cout << "vitr->distance(vitr + 1) = " << vitr.distance(vitr + 1)
              << std::endl;
    std::cout << "vitr->distance(vitr + 4) = " << vitr.distance(vitr + 4)
              << std::endl;
    std::cout << "vitr->distance(vitr + 6) = " << vitr.distance(vitr + 6)
              << std::endl;
    std::cout << "(vitr + 1).distance(vitr) = " << (vitr + 1).distance(vitr)
              << std::endl;
    std::cout << "(vitr + 4).distance(vitr) = " << (vitr + 4).distance(vitr)
              << std::endl;
    std::cout << "(vitr + 6).distance(vitr) = " << (vitr + 6).distance(vitr)
              << std::endl;
    std::cout << std::endl;
}
