...
void *data_mgr::require(const int typ)
{
    ...
    {
        case CRYPTO_PARAM_KEYGEN: {
            return _keygen_pool.acquire();
        }
        case CRYPTO_PARAM_ENCRYPT: {
            return _encrypt_pool.acquire();
        }
        case CRYPTO_PARAM_DECRYPT: {
            return _decrypt_pool.acquire();
        }
        default: {
            return nullptr;
        }
