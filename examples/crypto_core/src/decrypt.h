...
class decryptor
{
  public:
    ...
    virtual int                             decrypt(std::string       &out,
                                                    const std::string &in,
...
class decryptor_mgr
{
  public:
    ...
    ~decryptor_mgr() { _decryptors.clear(); }
...
class aes_decryptor : public decryptor
{
  public:
    ...
    {
        static std::vector<std::string> modes{"ecb",
                                              "cbc",
                                              "cfb1",
                                              "cfb8",
                                              "cfb128",
    ...
    {
        static std::vector<std::string> paddings{"pkcs5",
                                                 "pkcs7",
                                                 "zero",
                                                 "iso10126",
                                                 "ansix923",
  ...
  private:
    ...
    bool _is_key_valid(const std::string &key, const std::string &mode);
    bool _is_padding_valid(const std::string &padding);
    bool _is_iv_valid(const std::string &iv, const std::string &mode);
...
class rsa_decryptor : public decryptor
{
  public:
    ...
    inline const std::vector<std::string> &supported_paddings() override
    {
        static std::vector<std::string> paddings{"pkcs1",
                                                 "no_padding",
                                                 "pkcs1_oaep",
                                                 "x931",
                                                 "pkcs1_pss"};
  ...
  private:
    ...
    bool _is_input_valid(const std::string &out,
                         const std::string &in,
                         const std::string &content,
                         const std::string &key,
                         const std::string &padding);
