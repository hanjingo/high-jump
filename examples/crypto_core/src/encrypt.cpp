...
int encryptor_mgr::encrypt(std::string       &out,
                           const std::string &in,
...
// ------------------------------------ AES -------------------------------------
int aes_encryptor::encrypt(std::string       &out,
                           const std::string &in,
                           const std::string &content,
                           const std::string &mode,
                           const std::string &key,
...
bool aes_encryptor::_is_key_valid(const std::string &key,
                                  const std::string &mode)
{
    auto mod = str_to_aes_mode(mode);
...
bool aes_encryptor::_is_iv_valid(const std::string &iv, const std::string &mode)
{
...
bool aes_encryptor::_is_input_valid(const std::string &out,
                                    const std::string &in,
                                    const std::string &content,
                                    const std::string &mode,
                                    const std::string &key,
...
// ------------------------------------ BASE64 -------------------------------------
int base64_encryptor::encrypt(std::string       &out,
                              const std::string &in,
                              const std::string &content,
                              const std::string &mode,
                              const std::string &key,
...
// ------------------------------------ DES -------------------------------------
int des_encryptor::encrypt(std::string       &out,
                           const std::string &in,
                           const std::string &content,
                           const std::string &mode,
                           const std::string &key,
...
bool des_encryptor::_is_input_valid(const std::string &out,
                                    const std::string &in,
                                    const std::string &content,
                                    const std::string &padding)
{
...
bool des_encryptor::_is_key_valid(const std::string &key,
                                  const std::string &mode)
{
...
bool des_encryptor::_is_iv_valid(const std::string &iv, const std::string &mode)
{
    const unsigned char *iv_ptr =
        (iv == "") ? nullptr
                   : reinterpret_cast<const unsigned char *>(iv.c_str());
...
// ------------------------------------ MD5 -------------------------------------
int md5_encryptor::encrypt(std::string       &out,
                           const std::string &in,
                           const std::string &content,
                           const std::string &mode,
                           const std::string &key,
...
// ------------------------------------ SHA256 -------------------------------------
int sha256_encryptor::encrypt(std::string       &out,
                              const std::string &in,
                              const std::string &content,
                              const std::string &mode,
                              const std::string &key,
...
// ------------------------------------ RSA -------------------------------------
int rsa_encryptor::encrypt(std::string       &out,
                           const std::string &in,
                           const std::string &content,
                           const std::string &mode,
                           const std::string &key,
...
bool rsa_encryptor::_is_input_valid(const std::string &out,
                                    const std::string &in,
                                    const std::string &content,
                                    const std::string &key,
                                    const std::string &padding)
