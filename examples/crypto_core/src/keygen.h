...
class keymaker
{
  public:
    ...
    virtual int         make(std::vector<std::string> &keys,
...
class keymaker_mgr
{
  public:
    ...
    int                      make(std::vector<std::string> &outs,
...
class rsa_keymaker : public keymaker
{
  public:
    ...
    {
        static std::vector<std::string> modes{"none",
                                              "aes_128_ecb",
                                              "aes_192_ecb",
                                              "aes_256_ecb",
                                              "aes_128_cbc",
    ...
    int make(std::vector<std::string> &keys,
             const std::string        &fmt,
             const std::string        &mode,
