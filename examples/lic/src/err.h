...
INIT(hj::register_err("app", ERR_INVALID_SUBCMD, "invalid subcmd");
     ...
     hj::register_err("app",
                      ERR_LIC_CORE_VERSION_MISMATCH,
                      "lic core version mismatch");
     hj::register_err("app",
                      ERR_LIC_CORE_CLAIM_NUM_EXCEED,
                      "lic core claim num exceed");)

INIT(hj::register_err("lic", LIC_ERR_FAIL, "lic failed");
     ...
     hj::register_err("lic",
                      LIC_ERR_ISSUER_NOT_EXIST,
                      "lic issuer not existed");
     ...
     hj::register_err("lic",
                      LIC_ERR_INPUT_STREAM_INVALID,
                      "lic input stream invalid");
     hj::register_err("lic",
                      LIC_ERR_OUTPUT_STREAM_INVALID,
                      "lic output stream invalid");)
