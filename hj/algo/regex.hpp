...
static const char *PATTERN_IP_V4 = "((2[0-4]\\d|25[0-5]|[01]?\\d\\d?)\\.){\
3}(2[0-4]\\d|25[0-5]|[01]?\\d\\d?)";
static const char *PATTERN_PORT  = "^(6553[0-5]|655[0-2][0-9]|65[0-4][0-9]{\
2}|6[0-4][0-9]{3}|[1-5][0-9]{4}|[0-9]{1,4})$";
static const char *PATTERN_MAC   = "([0-9A-F]{2}-[0-9A-F]{2}-[0-9A-F]{2}-[\
