...
inline std::string decode(const std::wstring &str)
{
    std::wstring_convert<std::codecvt_utf8<wchar_t> > cvt;
    return cvt.to_bytes(str);
}

inline unsigned char *decode(unsigned char *out, const wchar_t *in)
{
    std::wstring_convert<std::codecvt_utf8<wchar_t> > converter;
    std::wstring                                      wstr(in);
...
inline std::wstring encode(const std::string &str)
{
    std::wstring_convert<std::codecvt_utf8<wchar_t> > cvt;
    return cvt.from_bytes(str);
}

inline wchar_t *encode(wchar_t *out, const unsigned char *in)
{
    std::wstring_convert<std::codecvt_utf8<wchar_t> > converter;
