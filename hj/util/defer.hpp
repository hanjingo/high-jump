...
#define DEFER(cmd) ::hj::defer _defer_cat(__simulate_go_defer__, __COUNTER__)([&]() { cmd; });
#define DEFER_CLASS(cmd) ::hj::::defer _defer_cat(__simulate_go_defer_class__, __COUNTER__)([&, this]() { cmd; });
