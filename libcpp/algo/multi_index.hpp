...
#define LIBCPP_INDEX_TAGS_7(_1, _2, _3, _4, _5, _6, _7)                        \
    ...
    LIBCPP_INDEX_TAG (_4)                                                      \
    LIBCPP_INDEX_TAG (_5)                                                      \
    LIBCPP_INDEX_TAG (_6) LIBCPP_INDEX_TAG (_7)
...
#define LIBCPP_GET_MAKE_TAGS_MACRO(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10,    \
                                   NAME, ...)                                  \
    NAME
#define LIBCPP_INDEX_TAGS(...)                                                 \
    LIBCPP_GET_MAKE_TAGS_MACRO (                                               \
      __VA_ARGS__, LIBCPP_INDEX_TAGS_10, LIBCPP_INDEX_TAGS_9,                  \
      LIBCPP_INDEX_TAGS_8, LIBCPP_INDEX_TAGS_7, LIBCPP_INDEX_TAGS_6,           \
      LIBCPP_INDEX_TAGS_5, LIBCPP_INDEX_TAGS_4, LIBCPP_INDEX_TAGS_3,           \
      LIBCPP_INDEX_TAGS_2, LIBCPP_INDEX_TAGS_1)                                \
    (__VA_ARGS__)
