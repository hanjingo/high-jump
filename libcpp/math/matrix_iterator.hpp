...
template <typename Mat, typename T> struct matrix_iterator
{
    ...
    matrix_iterator () : mat_{0}, row_{0}, col_{0}, n_row_{0}, n_col_{0} {}
    ...
    virtual T &at (const int row, const int col) { return (*mat_) (row, col); }
