...
struct vector2d_row_iterator {
    ...
    vector2d_row_iterator(const vector2d_row_iterator& itr)
        : vec_{itr.vec_}, row_{itr.row_}, col_{itr.col_}, n_row_{itr.n_row_}, n_col_{itr.n_col_}
    {}
    vector2d_row_iterator(Vec* vec, const int row, const int col, const int n_row, const int n_col)
    ...
    inline friend bool operator==(const vector2d_row_iterator& a, const vector2d_row_iterator& b) // itr1 == itr2
    {
    ...
    inline friend bool operator<(const vector2d_row_iterator& a, const vector2d_row_iterator& b)
    {
