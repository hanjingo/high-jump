      ...
      public:
                  ...
                  page_orientation orientation = page_orientation::portrait)
        {
            ...
            HPDF_PageDirection hpdf_direction =
              (orientation == page_orientation::portrait) ? HPDF_PAGE_PORTRAIT
                                                          : HPDF_PAGE_LANDSCAPE;
        ...
        {
            HPDF_Page_Rectangle (page_, rect.x, rect.y, rect.width,
                                 rect.height);
            if (fill)
        ...
        {
            return HPDF_Page_TextOut (page_, position.x, position.y,
                                      text.c_str ())
                   == HPDF_OK;
        }
        ...
        bool draw_image (const std::string &filename, const rectangle &rect)
        {
            ...
            if (image)
                HPDF_Page_DrawImage (page_, image, rect.x, rect.y, rect.width,
                                     rect.height);
            else
                return false;
                           ...
                           const rectangle &rectangle)
        {
            ...
            if (image)
                HPDF_Page_DrawImage (page_, image, rectangle.x, rectangle.y,
    ...
    class document
    {
      ...
      public:
        ...
        bool save_to_memory (std::vector<unsigned char> &out)
        {
            ...
            if (HPDF_ReadFromStream (doc_, out.data (), &actual_size)
                != HPDF_OK)
                return false;
