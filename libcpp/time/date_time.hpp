...
namespace timezone {
// ASIA
constexpr timezone_info BEIJING = { "Asia/Shanghai",
                                    "CST",
                                    8,
                                    0,
                                    "China Standard Time" };
constexpr timezone_info HONG_KONG = { "Asia/Hong_Kong",
                                      "HKT",
                                      8,
                                      0,
                                      "Hong Kong Time" };
constexpr timezone_info TOKYO = { "Asia/Tokyo",
                                  "JST",
                                  9,
                                  0,
                                  "Japan Standard Time" };
constexpr timezone_info SEOUL = { "Asia/Seoul",
                                  "KST",
                                  9,
                                  0,
                                  "Korea Standard Time" };
constexpr timezone_info MUMBAI = { "Asia/Kolkata",
                                   "IST",
                                   5,
                                   30,
                                   "India Standard Time" };
constexpr timezone_info BANGKOK = { "Asia/Bangkok",
                                    "ICT",
                                    7,
                                    0,
                                    "Indochina Time" };
constexpr timezone_info SINGAPORE = { "Asia/Singapore",
                                      "SGT",
                                      8,
                                      0,
                                      "Singapore Standard Time" };
constexpr timezone_info DUBAI = { "Asia/Dubai",
                                  "GST",
                                  4,
                                  0,
                                  "Gulf Standard Time" };
...
// EUROPE
constexpr timezone_info LONDON = { "Europe/London",
                                   "GMT",
                                   0,
                                   0,
                                   "Greenwich Mean Time" };
constexpr timezone_info BERLIN = { "Europe/Berlin",
                                   "CET",
                                   1,
                                   0,
                                   "Central European Time" };
constexpr timezone_info PARIS = { "Europe/Paris",
                                  "CET",
                                  1,
                                  0,
                                  "Central European Time" };
constexpr timezone_info ROME = { "Europe/Rome",
                                 "CET",
                                 1,
                                 0,
                                 "Central European Time" };
constexpr timezone_info MOSCOW = { "Europe/Moscow",
                                   "MSK",
                                   3,
                                   0,
                                   "Moscow Standard Time" };
constexpr timezone_info STOCKHOLM = { "Europe/Stockholm",
                                      "CET",
                                      1,
                                      0,
                                      "Central European Time" };
...
// AMERICAS
constexpr timezone_info NEW_YORK = { "America/New_York",
                                     "EST",
                                     -5,
                                     0,
                                     "Eastern Standard Time" };
constexpr timezone_info CHICAGO = { "America/Chicago",
                                    "CST",
                                    -6,
                                    0,
                                    "Central Standard Time" };
constexpr timezone_info DENVER = { "America/Denver",
                                   "MST",
                                   -7,
                                   0,
                                   "Mountain Standard Time" };
constexpr timezone_info LOS_ANGELES = { "America/Los_Angeles",
                                        "PST",
                                        -8,
                                        0,
                                        "Pacific Standard Time" };
constexpr timezone_info TORONTO = { "America/Toronto",
                                    "EST",
                                    -5,
                                    0,
                                    "Eastern Standard Time" };
constexpr timezone_info SAO_PAULO = { "America/Sao_Paulo",
                                      "BRT",
                                      -3,
                                      0,
                                      "Brazil Time" };
constexpr timezone_info MEXICO_CITY = { "America/Mexico_City",
                                        "CST",
                                        -6,
                                        0,
                                        "Central Standard Time" };
...
// AUSTRALIA & OCEANIA
constexpr timezone_info SYDNEY = { "Australia/Sydney",
                                   "AEST",
                                   10,
                                   0,
                                   "Australian Eastern Standard Time" };
constexpr timezone_info MELBOURNE = { "Australia/Melbourne",
                                      "AEST",
                                      10,
                                      0,
                                      "Australian Eastern Standard Time" };
constexpr timezone_info AUCKLAND = { "Pacific/Auckland",
                                     "NZST",
                                     12,
                                     0,
                                     "New Zealand Standard Time" };
constexpr timezone_info PERTH = { "Australia/Perth",
                                  "AWST",
                                  8,
                                  0,
...
// AFRICA
constexpr timezone_info CAIRO = { "Africa/Cairo",
                                  "EET",
                                  2,
                                  0,
                                  "Eastern European Time" };
constexpr timezone_info JOHANNESBURG = { "Africa/Johannesburg",
                                         "SAST",
                                         2,
                                         0,
                                         "South Africa Standard Time" };
constexpr timezone_info LAGOS = { "Africa/Lagos",
                                  "WAT",
                                  1,
                                  0,
                                  "West Africa Time" };
...
// other
constexpr timezone_info UTC = { "UTC",
                                "UTC",
                                0,
                                0,
  ...
  public:
    ...
    inline date_time start_of_week()
    {
        return day_of_week() == week_day::sunday
                   ? date_time(tm_.date() + boost::gregorian::date_duration(-6))
                         .start_of_day()
                   : date_time(tm_.date() +
