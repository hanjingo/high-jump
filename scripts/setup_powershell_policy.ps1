...
#
# Usage: .\setup_powershell_policy.ps1 [PolicyLevel] [Scope] [-WhatIf] [-Force]
#
# Parameters:
...
#   .\setup_powershell_policy.ps1 -PolicyLevel Unrestricted -Scope Process -Force
#   .\setup_powershell_policy.ps1 -WhatIf
...
USAGE:
    .\setup_powershell_policy.ps1 [PolicyLevel] [Scope] [-WhatIf] [-Force] [-Help]
...
EXAMPLES:
    ...
    .\setup_powershell_policy.ps1 Unrestricted Process -Force

    # Check what would be changed without applying
    .\setup_powershell_policy.ps1 AllSigned LocalMachine -WhatIf

    # Set policy for all users (requires admin privileges)
    .\setup_powershell_policy.ps1 RemoteSigned LocalMachine
