...
TEST (aes, encode)
{
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs7_padding),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
      "8CAC1119CB4DD87A51FE8824C3694A38D96AA42B59151A9E9B5925FC9D95ADAF");
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_zero_padding),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_iso10126_padding),
               true);
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_ansix923_padding),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_no_padding),
               true);
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key192,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key192, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key256,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key256, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs7_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
      "742D1C448000B6A944D14E960E0248A56E5B78B1A23B996B46407E5F67B51627");
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::cbc,
                                    libcpp::aes::padding::aes_zero_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_iso10126_padding, iv),
      true);
    ...
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_ansix923_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key128, libcpp::aes::algo::cbc,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (libcpp::aes::encode (str_dst, str_src, key128,
                                    libcpp::aes::algo::cbc,
                                    libcpp::aes::padding::aes_no_padding, iv),
               true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key192, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key192, libcpp::aes::algo::cbc,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key256, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key256, libcpp::aes::algo::cbc,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key128, libcpp::aes::algo::cfb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key192, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key192, libcpp::aes::algo::cfb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key256, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key256, libcpp::aes::algo::cfb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key128, libcpp::aes::algo::ofb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key192, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key192, libcpp::aes::algo::ofb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key256, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key256, libcpp::aes::algo::ofb,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key128, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key128, libcpp::aes::algo::ctr,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key192, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key192, libcpp::aes::algo::ctr,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (
      libcpp::aes::encode (str_dst, str_src, key256, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
    ...
    str_dst.clear ();
    ASSERT_EQ (libcpp::aes::encode (
                 str_dst, str_src, key256, libcpp::aes::algo::ctr,
                 libcpp::aes::padding::aes_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (
      aes_test_to_hex (str_dst).c_str (),
...
TEST (aes, decode)
{
    ...
    str_src = aes_test_to_bytes (
      "8CAC1119CB4DD87A51FE8824C3694A38D96AA42B59151A9E9B5925FC9D95ADAF");
    ASSERT_EQ (libcpp::aes::decode (str_dst, str_src, key128,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
    ...
    str_src = aes_test_to_bytes (
      "8CAC1119CB4DD87A51FE8824C3694A381FF14EEF93A23B23219C80D71AFC105E");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key128, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "406E2B7A955B830CEB5E9E8867DEA8855DAE4B81861BE13861BF21861C5A3199");
    ASSERT_EQ (libcpp::aes::decode (str_dst, str_src, key192,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
    ...
    str_src = aes_test_to_bytes (
      "406E2B7A955B830CEB5E9E8867DEA885FE4110A9214DCB0194CB6AF8CDE8FE9D");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key192, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "45EE1BD897FD37E0F2E3843C7000E1CBEEBBDAED7324EC4BC70D1C0343337233");
    ASSERT_EQ (libcpp::aes::decode (str_dst, str_src, key256,
                                    libcpp::aes::algo::ecb,
                                    libcpp::aes::padding::aes_pkcs5_padding),
               true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
    ...
    str_src = aes_test_to_bytes (
      "45EE1BD897FD37E0F2E3843C7000E1CB7AA312308994119CDE6DED1826EB9AA0");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key256, libcpp::aes::algo::ecb,
                           libcpp::aes::padding::aes_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "742D1C448000B6A944D14E960E0248A56E5B78B1A23B996B46407E5F67B51627");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key128, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "5E559B496C47EA672844622A5B862DCDE14B48F0F48FBFD643B127F21B894CE5");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key192, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "43D77E30642AE42D62852522EA1A70FD2D8756D35007D18C3ADFE10E4108A00B");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key256, libcpp::aes::algo::cbc,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "A38D19F76F00C0C23B5726C2777D758309A1D7AB5CA1C7093A370C4F511A94AD");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key128, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "2B9548B149F87264A6C0C48A55314C5F87BF5553483056FB92A998EA07AB0D72");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key192, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "F804466E2B35C3323332DE6E633FA65B652327F51EB9E5E6A97BF78814A61DC0");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key256, libcpp::aes::algo::cfb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "A38D19F76F00C0C23B5726C2777D7583D19C72E677A12D656E839C70255DE6FA");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key128, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "2B9548B149F87264A6C0C48A55314C5F8566926EAC19A95B135FB3B50EC29686");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key192, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "F804466E2B35C3323332DE6E633FA65B4250ABF28FA751C889B12A11DDA870CD");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key256, libcpp::aes::algo::ofb,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "A38D19F76F00C0C23B5726C2777D7583FC10D8181B1EF01B41704AE789A34D7F");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key128, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "2B9548B149F87264A6C0C48A55314C5F4D88D644EF60A935451AB6FD6F720B57");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key192, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    str_src = aes_test_to_bytes (
      "F804466E2B35C3323332DE6E633FA65B1D38A644453C4671441D516ECB540EE1");
    ASSERT_EQ (
      libcpp::aes::decode (str_dst, str_src, key256, libcpp::aes::algo::ctr,
                           libcpp::aes::padding::aes_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (aes_test_to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
...
TEST (aes, encode_file)
{
    ...
    ASSERT_EQ (libcpp::aes::encode_file (
                 std::string ("./aes_ecb_pkcs5_padding_encode.log"), str_src,
                 key128, libcpp::aes::algo::ecb,
                 libcpp::aes::padding::aes_pkcs5_padding, iv),
               true);
}
...
TEST (aes, decode_file)
{
    ...
    ASSERT_EQ (libcpp::aes::decode_file (
                 str_dst, str_src, key128, libcpp::aes::algo::ecb,
                 libcpp::aes::padding::aes_pkcs5_padding),
               true);
}
...
{
    ASSERT_TRUE (libcpp::aes::encode_len_reserve (8, libcpp::aes::algo::ecb, 8)
                 == 32);
}
...
TEST (aes, is_key_valid)
{
    unsigned char key[32] = {0};
    ASSERT_EQ (
      libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, sizeof (key)),
      true);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 16),
               true);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 24),
               true);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 32),
               true);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 15),
               false);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 25),
               false);
    ASSERT_EQ (libcpp::aes::is_key_valid (libcpp::aes::algo::ecb, key, 33),
               false);
}
