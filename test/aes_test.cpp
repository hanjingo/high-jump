...
TEST(aes, encode)
{
    ...
    str_dst.clear();
    ASSERT_EQ(libcpp::aes::encode(str_dst,
                                  str_src,
                                  key128,
                                  libcpp::aes::algo::ecb,
...
TEST(aes, decode)
{
    ...
    str_src = aes_test_to_bytes(
        "8CAC1119CB4DD87A51FE8824C3694A38D96AA42B59151A9E9B5925FC9D95ADAF");
    ASSERT_EQ(libcpp::aes::decode(str_dst,
                                  str_src,
                                  key128,
                                  libcpp::aes::algo::ecb,
                                  libcpp::aes::padding::aes_pkcs5_padding),
...
TEST(aes, encode_file)
{
    ...
    ASSERT_EQ(libcpp::aes::encode_file(
                  std::string("./aes_ecb_pkcs5_padding_encode.log"),
                  str_src,
                  key128,
                  libcpp::aes::algo::ecb,
                  libcpp::aes::padding::aes_pkcs5_padding,
...
TEST(aes, decode_file)
{
    ...
    ASSERT_EQ(libcpp::aes::decode_file(str_dst,
                                       str_src,
                                       key128,
                                       libcpp::aes::algo::ecb,
                                       libcpp::aes::padding::aes_pkcs5_padding),
