            ...
            for (int x = 0; x < width; x++)
            {
                ...
                for (const auto& neighbor : potential_neighbors)
                {
                    if (neighbor.x >= 0 && neighbor.x < width &&
                        ...
                        std::find(obstacles.begin(),
                                  obstacles.end(),
                                  neighbor) == obstacles.end())
                    {
...
TEST_F(AStarTest, path_smoothing)
{
    ...
    // Test single point
    std::vector<location_t> single_path = {
        { 0, 0 }
    };
    ...
    // Test two points
    std::vector<location_t> two_path = {
        { 0, 0 },
        { 1, 1 }
    };
    ...
    std::vector<location_t> collinear_path = {
        { 0, 0 },
        { 1, 0 },
        { 2, 0 },
        { 3, 0 }
...
TEST_F(AStarTest, grid_construction)
{
    ...
    std::vector<location_t> center_neighbors = {
        { 0, 1 },
        { 2, 1 },
        { 1, 0 },
        { 1, 2 }
...
TEST_F(AStarTest, search_with_obstacles_detailed)
{
    ...
    std::vector<location_t> obstacles = {
        { 1, 0 },
        { 1, 1 }
    };
