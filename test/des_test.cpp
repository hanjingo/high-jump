...
TEST(des, encode)
{
    ...
    str_dst.clear();
    str_src = "hello world";
    ASSERT_EQ(libcpp::des::encode(str_dst,
                                  str_src,
                                  key,
                                  libcpp::des::algo::des_ecb,
                                  libcpp::des::padding::des_pkcs5_padding),
...
TEST(des, decode)
{
    ...
    ASSERT_EQ(libcpp::des::decode(str_dst,
                                  str_src,
                                  key,
                                  libcpp::des::algo::des_ecb,
                                  libcpp::des::padding::des_pkcs5_padding),
...
TEST(des, encode_file)
{
    ...
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ecb_pkcs5_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ecb,
                  libcpp::des::padding::des_pkcs5_padding),
    ...
    // ECB padding PKCS#7
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ecb_pkcs7_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ecb,
                  libcpp::des::padding::des_pkcs7_padding),
    ...
    // ECB padding 0
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ecb_zero_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ecb,
                  libcpp::des::padding::des_zero_padding),
    ...
    // ECB padding ISO10126 （random result）
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ecb_iso10126_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ecb,
                  libcpp::des::padding::des_iso10126_padding),
    ...
    // ECB padding ANSIX923
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ecb_ansix923_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ecb,
                  libcpp::des::padding::des_ansix923_padding),
    ...
    // ECB padding NOPADDING
    ASSERT_EQ(
        libcpp::des::encode_file(std::string("./des_ecb_no_padding_encode.log"),
                                 str_src_nopadding,
                                 key,
                                 libcpp::des::algo::des_ecb,
                                 libcpp::des::padding::des_no_padding),
    ...
    // CBC padding PKCS#5
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cbc_pkcs5_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cbc,
                  libcpp::des::padding::des_pkcs5_padding,
    ...
    // CBC padding PKCS#7
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cbc_pkcs7_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cbc,
                  libcpp::des::padding::des_pkcs7_padding,
    ...
    // CBC padding 0
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cbc_zero_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cbc,
                  libcpp::des::padding::des_zero_padding,
    ...
    // CBC padding ISO10126 （random result）
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cbc_iso10126_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cbc,
                  libcpp::des::padding::des_iso10126_padding,
    ...
    // CBC padding ANSIX923
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cbc_ansix923_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cbc,
                  libcpp::des::padding::des_ansix923_padding,
    ...
    // CBC padding NOPADDING
    ASSERT_EQ(
        libcpp::des::encode_file(std::string("./des_cbc_no_padding_encode.log"),
                                 str_src_nopadding,
                                 key,
                                 libcpp::des::algo::des_cbc,
                                 libcpp::des::padding::des_no_padding,
    ...
    // CFB padding PKCS#5
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cfb_pkcs5_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cfb,
                  libcpp::des::padding::des_pkcs5_padding,
    ...
    // CFB padding PKCS#7
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cfb_pkcs7_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cfb,
                  libcpp::des::padding::des_pkcs7_padding,
    ...
    // CFB padding 0
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cfb_zero_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cfb,
                  libcpp::des::padding::des_zero_padding,
    ...
    // CFB padding ISO10126 （random result）
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cfb_iso10126_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cfb,
                  libcpp::des::padding::des_iso10126_padding,
    ...
    // CFB padding ANSIX923
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_cfb_ansix923_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_cfb,
                  libcpp::des::padding::des_ansix923_padding,
    ...
    // CFB padding NOPADDING
    ASSERT_EQ(
        libcpp::des::encode_file(std::string("./des_cfb_no_padding_encode.log"),
                                 str_src_nopadding,
                                 key,
                                 libcpp::des::algo::des_cfb,
                                 libcpp::des::padding::des_no_padding,
    ...
    // OFB padding PKCS#5
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ofb_pkcs5_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ofb,
                  libcpp::des::padding::des_pkcs5_padding,
    ...
    // OFB padding PKCS#7
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ofb_pkcs7_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ofb,
                  libcpp::des::padding::des_pkcs7_padding,
    ...
    // OFB padding 0
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ofb_zero_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ofb,
                  libcpp::des::padding::des_zero_padding,
    ...
    // OFB padding ISO10126 （random result）
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ofb_iso10126_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ofb,
                  libcpp::des::padding::des_iso10126_padding,
    ...
    // OFB padding ANSIX923
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ofb_ansix923_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ofb,
                  libcpp::des::padding::des_ansix923_padding,
    ...
    // OFB padding NOPADDING
    ASSERT_EQ(
        libcpp::des::encode_file(std::string("./des_ofb_no_padding_encode.log"),
                                 str_src_nopadding,
                                 key,
                                 libcpp::des::algo::des_ofb,
                                 libcpp::des::padding::des_no_padding,
    ...
    // CTR padding PKCS#5
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ctr_pkcs5_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ctr,
                  libcpp::des::padding::des_pkcs5_padding,
    ...
    // CTR padding PKCS#7
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ctr_pkcs7_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ctr,
                  libcpp::des::padding::des_pkcs7_padding,
    ...
    // CTR padding 0
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ctr_zero_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ctr,
                  libcpp::des::padding::des_zero_padding,
    ...
    // CTR padding ISO10126 （random result）
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ctr_iso10126_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ctr,
                  libcpp::des::padding::des_iso10126_padding,
    ...
    // CTR padding ANSIX923
    ASSERT_EQ(libcpp::des::encode_file(
                  std::string("./des_ctr_ansix923_padding_encode.log"),
                  str_src,
                  key,
                  libcpp::des::algo::des_ctr,
                  libcpp::des::padding::des_ansix923_padding,
    ...
    // CTR padding NOPADDING
    ASSERT_EQ(
        libcpp::des::encode_file(std::string("./des_ctr_no_padding_encode.log"),
                                 str_src_nopadding,
                                 key,
                                 libcpp::des::algo::des_ctr,
                                 libcpp::des::padding::des_no_padding,
...
TEST(des, decode_file)
{
    ...
    ASSERT_EQ(libcpp::des::decode_file(str_dst,
                                       str_src,
                                       key,
                                       libcpp::des::algo::des_ecb,
                                       libcpp::des::padding::des_pkcs5_padding),
    ...
    ASSERT_EQ(
        libcpp::des::decode_file(str_dst,
                                 str_src,
                                 key,
                                 libcpp::des::algo::des_ecb,
                                 libcpp::des::padding::des_iso10126_padding),
