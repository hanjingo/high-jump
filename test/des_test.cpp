...
TEST (des, encode)
{
    ...
    ASSERT_EQ (libcpp::des::encode (
                 out, in,
                 reinterpret_cast<const unsigned char *> (key.c_str ()),
                 key.size (), libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_pkcs5_padding),
               true);
    ASSERT_STREQ (to_hex (out.str ()).c_str (),
                  "28DBA02EB5F6DD47AA291D16D82146BF");

    // ECB padding PKCS#5
    str_dst.clear ();
    str_src = "hello world";
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_pkcs7_padding),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "28DBA02EB5F6DD47AA291D16D82146BF");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_zero_padding),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "28DBA02EB5F6DD47535FFDB06574A87D");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_iso10126_padding),
               true);
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_ansix923_padding),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_ecb,
                           libcpp::des::padding::des_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_no_padding),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "28DBA02EB5F6DD47BABFF98EFA6DB628");
    ...
    str_src = "hello world";
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_cbc,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "B72D0DC9E9433B0373FB9C7373EEE4D1");
    ...
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_cbc,
                           libcpp::des::padding::des_pkcs7_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "B72D0DC9E9433B03849FE655EE80DB80");

    // CBC padding 0
    str_dst.clear ();
    str_src = "hello world 12";
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_cbc,
                                    libcpp::des::padding::des_zero_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "B72D0DC9E9433B0353E3BE76EB413AB0");
    ...
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_cbc,
                           libcpp::des::padding::des_iso10126_padding, iv),
      true);
    ...
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_cbc,
                           libcpp::des::padding::des_ansix923_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
    ...
    str_src = "hello world 12345";
    ASSERT_EQ (libcpp::des::encode (
                 str_dst, str_src, key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_cbc,
                                    libcpp::des::padding::des_no_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "B72D0DC9E9433B031400731AF6B95E3B");

    // CFB padding PKCS#5
    str_dst.clear ();
    str_src = "hello world 1234";
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_cfb,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "FCB12F07AC95C1FC248142DD0763FF3B");

    // CFB padding 0
    str_dst.clear ();
    str_src = "hello world 12";
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_cfb,
                                    libcpp::des::padding::des_zero_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "FCB12F07AC95C1FC248142DD0763CC3A");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "FCB12F07AC95C1FC248142FD3651CC3F");

    // CFB padding ISO/IEC 7816-4
    str_dst.clear ();
    str_src = "hello world 1";
    ASSERT_EQ (libcpp::des::encode (
                 str_dst, str_src, key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "FCB12F07AC95C1FC248142DD07D1CC3A");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "FCB12F07AC95C1FC248142DD0763FF0E");

    // OFB padding PKCS#5
    str_dst.clear ();
    str_src = "libcpp";
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_ofb,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ...
    str_src = "libcpp12";
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ofb,
                                    libcpp::des::padding::des_zero_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "F8BD2108B3C587A14B6BB3A9E45E6967");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "F8BD2108B3C587A1785FB3A9E45E6961");

    // OFB padding ISO/IEC 7816-4
    str_dst.clear ();
    str_src = "libcpp12345";
    ASSERT_EQ (libcpp::des::encode (
                 str_dst, str_src, key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "F8BD2108B3C587A1785F8629E45E6967");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "A5E6705FF68381AB7A59809DD1685E5F");
    ...
    str_src = "1";
    ASSERT_EQ (
      libcpp::des::encode (str_dst, str_src, key, libcpp::des::algo::des_ctr,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ...
    str_src = "123456";
    ASSERT_EQ (libcpp::des::encode (
                 str_dst, str_src, key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);
...
TEST (des, encode_n)
{
    ...
    ASSERT_EQ (libcpp::des::encode (
               ...
               true);
    ASSERT_STREQ (to_hex (out.str ()).c_str (),
                  "3E4665C52F935552F1C9C86E67880CBB");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "77910467EA549E870607FEDECED97190");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "77910467EA549E875122F18A882D6318");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "77910467EA549E87D3A3E13D0A9DBC1D");
    ...
    ASSERT_EQ (libcpp::des::encode (
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "77910467EA549E876D62899FA608C319");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "77910467EA549E87E5C4991F4D218550");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED4F4B5090F2BA835F");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED4F4B5095F7BF865A");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED4F4B5095F7BF865F");
    ...
    ASSERT_EQ (libcpp::des::encode (
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED4F4B5015F7BF865A");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED4F4B50B5C38CB46B");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED66BC7B1B96753DD5");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED66BC7B1E937038D0");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED66BC7B1E937038D5");
    ...
    ASSERT_EQ (libcpp::des::encode (
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644ED66BC7B9E937038D0");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644EDF85DF1975DDF811E");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644EDF85DF19258DA841B");
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644EDF85DF19258DA841E");
    ...
    ASSERT_EQ (libcpp::des::encode (
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644EDF85DF11258DA841B");
    ...
    ASSERT_EQ (libcpp::des::encode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "8BA580A7B50644EDF85DF1B269E8B72F");
}
...
TEST (des, decode)
{
    ...
    ASSERT_EQ (libcpp::des::decode (str_dst, str_src, key,
                                    libcpp::des::algo::des_ecb,
                                    libcpp::des::padding::des_pkcs5_padding),
               true);
    ...
    ASSERT_EQ (
      libcpp::des::decode (str_dst, str_src, key, libcpp::des::algo::des_ecb,
                           libcpp::des::padding::des_iso_iec_7816_4_padding),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C64203132333435");
    ...
    ASSERT_EQ (
      libcpp::des::decode (str_dst, str_src, key, libcpp::des::algo::des_cbc,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (), "68656C6C6F20776F726C64");
    ...
    ASSERT_EQ (
      libcpp::des::decode (str_dst, str_src, key, libcpp::des::algo::des_cfb,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642031323334");
    ...
    ASSERT_EQ (
      libcpp::des::decode (str_dst, str_src, key, libcpp::des::algo::des_ofb,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
    ...
    ASSERT_EQ (
      libcpp::des::decode (str_dst, str_src, key, libcpp::des::algo::des_ctr,
                           libcpp::des::padding::des_pkcs5_padding, iv),
      true);
...
TEST (des, decode_n)
{
    ...
    ASSERT_EQ (libcpp::des::decode (str_dst, str_src, key,
               ...
               true);
    ASSERT_STREQ (to_hex (str_dst).c_str (),
                  "68656C6C6F20776F726C642034333231");
...
TEST (des, encode_file)
{
    ...
    // ECB padding PKCS#5
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_pkcs5_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_pkcs5_padding),
               true);

    // ECB padding PKCS#7
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_pkcs7_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_pkcs7_padding),
               true);
    ...
    // ECB padding 0
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_zero_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_zero_padding),
               true);
    ...
    // ECB padding ISO10126 （random result）
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_iso10126_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_iso10126_padding),
               true);
    ...
    // ECB padding ANSIX923
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_ansix923_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_ansix923_padding),
               true);
    ...
    // ECB padding ISO/IEC 7816-4
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_iso_iec_7816_4_padding_encode.log"),
                 str_src, key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_iso_iec_7816_4_padding),
               true);

    // ECB padding NOPADDING
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ecb_no_padding_encode.log"),
                 str_src_nopadding, key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_no_padding),
               true);

    // CBC padding PKCS#5
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_pkcs5_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_pkcs5_padding, iv),
               true);

    // CBC padding PKCS#7
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_pkcs7_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_pkcs7_padding, iv),
               true);
    ...
    // CBC padding 0
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_zero_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_zero_padding, iv),
               true);
    ...
    // CBC padding ISO10126 （random result）
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_iso10126_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_iso10126_padding, iv),
               true);
    ...
    // CBC padding ANSIX923
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_ansix923_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_ansix923_padding, iv),
               true);
    ...
    // CBC padding ISO/IEC 7816-4
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_iso_iec_7816_4_padding_encode.log"),
                 str_src, key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);

    // CBC padding NOPADDING
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cbc_no_padding_encode.log"),
                 str_src_nopadding, key, libcpp::des::algo::des_cbc,
                 libcpp::des::padding::des_no_padding, iv),
               true);

    // CFB padding PKCS#5
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_pkcs5_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_pkcs5_padding, iv),
               true);

    // CFB padding PKCS#7
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_pkcs7_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_pkcs7_padding, iv),
               true);
    ...
    // CFB padding 0
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_zero_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_zero_padding, iv),
               true);
    ...
    // CFB padding ISO10126 （random result）
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_iso10126_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_iso10126_padding, iv),
               true);
    ...
    // CFB padding ANSIX923
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_ansix923_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_ansix923_padding, iv),
               true);
    ...
    // CFB padding ISO/IEC 7816-4
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_iso_iec_7816_4_padding_encode.log"),
                 str_src, key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);

    // CFB padding NOPADDING
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_cfb_no_padding_encode.log"),
                 str_src_nopadding, key, libcpp::des::algo::des_cfb,
                 libcpp::des::padding::des_no_padding, iv),
               true);

    // OFB padding PKCS#5
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_pkcs5_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_pkcs5_padding, iv),
               true);

    // OFB padding PKCS#7
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_pkcs7_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_pkcs7_padding, iv),
               true);
    ...
    // OFB padding 0
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_zero_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_zero_padding, iv),
               true);
    ...
    // OFB padding ISO10126 （random result）
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_iso10126_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_iso10126_padding, iv),
               true);
    ...
    // OFB padding ANSIX923
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_ansix923_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_ansix923_padding, iv),
               true);
    ...
    // OFB padding ISO/IEC 7816-4
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_iso_iec_7816_4_padding_encode.log"),
                 str_src, key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);

    // OFB padding NOPADDING
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ofb_no_padding_encode.log"),
                 str_src_nopadding, key, libcpp::des::algo::des_ofb,
                 libcpp::des::padding::des_no_padding, iv),
               true);

    // CTR padding PKCS#5
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_pkcs5_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_pkcs5_padding, iv),
               true);

    // CTR padding PKCS#7
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_pkcs7_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_pkcs7_padding, iv),
               true);
    ...
    // CTR padding 0
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_zero_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_zero_padding, iv),
               true);
    ...
    // CTR padding ISO10126 （random result）
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_iso10126_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_iso10126_padding, iv),
               true);
    ...
    // CTR padding ANSIX923
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_ansix923_padding_encode.log"), str_src,
                 key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_ansix923_padding, iv),
               true);
    ...
    // CTR padding ISO/IEC 7816-4
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_iso_iec_7816_4_padding_encode.log"),
                 str_src, key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_iso_iec_7816_4_padding, iv),
               true);

    // CTR padding NOPADDING
    ASSERT_EQ (libcpp::des::encode_file (
                 std::string ("./des_ctr_no_padding_encode.log"),
                 str_src_nopadding, key, libcpp::des::algo::des_ctr,
                 libcpp::des::padding::des_no_padding, iv),
               true);
}
...
TEST (des, decode_file)
{
    ...
    ASSERT_EQ (libcpp::des::decode_file (
                 str_dst, str_src, key, libcpp::des::algo::des_ecb,
                 libcpp::des::padding::des_pkcs5_padding),
               true);
    ...
    ASSERT_EQ (libcpp::des::decode_file (str_dst, str_src, key,
                                         libcpp::des::algo::des_ecb,
                                         libcpp::des::padding::des_no_padding),
               true);
