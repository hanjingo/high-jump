...
//     if (ret < 0) {
//         std::cerr << "DPDK EAL init failed, check hugepage and permissions!"
//         << std::endl;
//     }
//     ASSERT_GE(ret, 0);
// }
...
//     if (nb_ports == 0)
//     {
//         std::cerr << "ERROR: No available Ethernet ports found!" <<
//         std::endl; return;
//     }
...
//     struct rte_mempool* mbuf_pool = rte_pktmbuf_pool_create(pool_name,
//     num_mbufs, 0, 0, mbuf_size, socket_id); ASSERT_NE(mbuf_pool, nullptr);
// }
