...
struct MonsterBuilder
{
    ...
    void add_id(int32_t id) { fbb_.AddElement<int32_t>(Monster::VT_ID, id, 0); }
    void add_name(::flatbuffers::Offset<::flatbuffers::String> name)
    {
        fbb_.AddOffset(Monster::VT_NAME, name);
    }
    void add_hp(int16_t hp) { fbb_.AddElement<int16_t>(Monster::VT_HP, hp, 0); }
    void add_damage(float damage)
    {
        fbb_.AddElement<float>(Monster::VT_DAMAGE, damage, 0.0f);
    }
    explicit MonsterBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
