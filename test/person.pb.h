...
/* @@protoc_insertion_point(class_definition:test.Person) */ {
  ...
  private:
    ...
    static ::uint8_t *
    _InternalSerialize (const MessageLite &msg,
                        ::uint8_t *target,
  ...
  protected:
    ...
    static void *
    PlacementNew_ (const void *, void *mem, ::google::protobuf::Arena *arena);
  ...
  private:
    ...
    static const ::google::protobuf::internal::TcParseTable<2, 3, 0, 29, 2>
      _table_;
    ...
    struct Impl_
    {
        inline explicit constexpr
          Impl_ (::google::protobuf::internal::ConstantInitialized) noexcept;
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Person::set_email (Arg_ &&arg, Args_... args)
{
    ::google::protobuf::internal::TSanWrite (&_impl_);
    _impl_._has_bits_[0] |= 0x00000002u;
