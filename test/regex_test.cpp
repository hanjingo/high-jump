...
TEST (regex, match)
{
    ...
    ASSERT_EQ (
      std::regex_match ("123.4", std::regex (libcpp::PATTERN_DECIMALS1)), true);
    ASSERT_EQ (
      std::regex_match ("123.45", std::regex (libcpp::PATTERN_DECIMALS1)),
      false);
    ASSERT_EQ (
      std::regex_match ("123.a", std::regex (libcpp::PATTERN_DECIMALS1)),
      false);
    ASSERT_EQ (std::regex_match ("a.1", std::regex (libcpp::PATTERN_DECIMALS1)),
               false);

    ASSERT_EQ (
      std::regex_match ("123.45", std::regex (libcpp::PATTERN_DECIMALS2)),
      true);
    ASSERT_EQ (
      std::regex_match ("123.456", std::regex (libcpp::PATTERN_DECIMALS2)),
      false);
    ASSERT_EQ (
      std::regex_match ("123.ab", std::regex (libcpp::PATTERN_DECIMALS2)),
      false);
    ASSERT_EQ (
      std::regex_match ("ab.12", std::regex (libcpp::PATTERN_DECIMALS2)),
      false);
    ...
    ASSERT_EQ (
      std::regex_match ("a123", std::regex (libcpp::PATTERN_NUM_LATTER)), true);
    ASSERT_EQ (
    ...
    ASSERT_EQ (
      ...
      true);
    ASSERT_EQ (
      std::regex_match ("123.", std::regex (libcpp::PATTERN_NUM_LATTER)),
      false);
    ASSERT_EQ (
      std::regex_match (".A123b", std::regex (libcpp::PATTERN_NUM_LATTER)),
      false);
    ASSERT_EQ (
      std::regex_match ("123.b", std::regex (libcpp::PATTERN_NUM_LATTER)),
      false);
    ...
    ASSERT_EQ (
      ...
      false);
    ASSERT_EQ (
      std::regex_match ("-1.0.0.0", std::regex (libcpp::PATTERN_IP_V4)), false);
    ASSERT_EQ (
      std::regex_match ("0.0.0.0.0", std::regex (libcpp::PATTERN_IP_V4)),
      false);
    ...
    ASSERT_EQ (std::regex_match ("65535", std::regex (libcpp::PATTERN_PORT)),
               true);
    ASSERT_EQ (std::regex_match ("-1", std::regex (libcpp::PATTERN_PORT)),
               false);
