...
TEST(date_time, now)
{
    ...
    ASSERT_TRUE(hj::date_time::now(hj::timezone::BEIJING).time() > hj::date_time::now(hj::timezone::UTC).time());
}
...
TEST(date_time, format)
{
    ...
    ASSERT_STREQ(
        hj::date_time::format(tm, TIME_FMT).c_str(), 
        "2023-01-01 00:00:00"
    );

    ASSERT_STREQ(
        hj::date_time::format(tm, "%Y%m%d-%H:%M:%S").c_str(), 
        "20230101-00:00:00"
    );
}
...
{
    ASSERT_EQ(
        hj::date_time::parse("2023-01-01 00:00:00", TIME_FMT).time(), hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );

    hj::date_time dt;
    hj::date_time::parse(dt, std::string("2023-01-01 00:00:00"), std::string(TIME_FMT));
...
{
    ASSERT_STREQ(
        hj::date_time(2023, 1, 1, 0, 0, 0).string().c_str(), 
        "2023-01-01 00:00:00"
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 0, 59, 59).minutes_to(
            hj::date_time(2023, 1, 1, 1, 0, 0)), 
        0
    );

    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 0, 59, 0).minutes_to(
            hj::date_time(2023, 1, 1, 1, 0, 0)), 
        1
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 23, 59, 59).hours_to(
            hj::date_time(2023, 1, 2, 0, 0, 0)), 
        0
    );

    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 23, 0, 0).hours_to(
            hj::date_time(2023, 1, 2, 0, 0, 0)), 
        1
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 23, 59, 59).days_to(
            hj::date_time(2023, 1, 2, 0, 0, 0)), 
        0
    );

    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 0, 0, 0).days_to(
            hj::date_time(2023, 1, 2, 0, 0, 0)), 
        1
    );
}
...
{
    ASSERT_TRUE(hj::date_time(2023, 1, 31, 0, 0, 0).day_of_week() == hj::week_day::tuesday);
}
...
{
    ASSERT_EQ(hj::date_time(2023, 1, 31, 0, 0, 0).month(), static_cast<hj::moon>(1));
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 12, 1, 1).start_of_day().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 1, 12, 1, 1).end_of_day().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).start_of_week().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 0, 0).end_of_week().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).start_of_month().time(), 
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 30, 12, 1, 1).end_of_month().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 30, 12, 1, 1).start_of_quarter().time(), 
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 30, 12, 1, 1).end_of_quarter().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 7, 1, 12, 1, 1).start_of_half_year().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 7, 1, 12, 1, 1).end_of_half_year().time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).start_of_year().time(), 
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).end_of_year().time(), 
        hj::date_time(2023, 12, 31, 23, 59, 59).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).next_day().time(), 
        hj::date_time(2023, 2, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 1, 31, 12, 1, 1).next_day(3).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_day().time(), 
        hj::date_time(2023, 1, 31, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_day(5).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2025, 7, 12, 0, 0, 0).next_weekday(hj::week_day::monday).time(), 
        hj::date_time(2025, 7, 14, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2025, 7, 12, 0, 0, 0).next_weekday(hj::week_day::friday).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2025, 7, 12, 0, 0, 0).pre_weekday(hj::week_day::monday).time(), 
        hj::date_time(2025, 7, 7, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2025, 7, 12, 0, 0, 0).pre_weekday(hj::week_day::friday).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2025, 7, 11).next_working_day().time(), 
        hj::date_time(2025, 7, 14, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2025, 7, 11).next_working_day(5).time(), 
        hj::date_time(2025, 7, 18, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2025, 7, 11).next_working_day(6).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2025, 7, 11).pre_working_day().time(),
        hj::date_time(2025, 7, 10, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2025, 7, 11).pre_working_day(5).time(),
        hj::date_time(2025, 7, 4, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2025, 7, 11).pre_working_day(10).time(),
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_month().time(), 
        hj::date_time(2023, 3, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_month(3).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_month().time(), 
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_month(3).time(), 
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_quarter().time(), 
        hj::date_time(2023, 4, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_quarter(2).time(), 
        hj::date_time(2023, 7, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 15).next_quarter().time(),
        hj::date_time(2023, 4, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 2, 15).next_quarter(2).time(),
        hj::date_time(2023, 7, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 11, 15).next_quarter().time(),
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_quarter().time(), 
        hj::date_time(2022, 10, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_quarter(2).time(), 
        hj::date_time(2022, 7, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 5, 15).pre_quarter().time(),
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 2, 15).pre_quarter().time(),
        hj::date_time(2022, 10, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_half_year().time(), 
        hj::date_time(2023, 7, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_half_year(3).time(), 
        hj::date_time(2024, 7, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 3, 15).next_half_year().time(),
        hj::date_time(2023, 7, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 9, 15).next_half_year().time(),
        hj::date_time(2024, 1, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 9, 15).pre_half_year().time(),
        hj::date_time(2023, 1, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 3, 15).pre_half_year().time(),
        hj::date_time(2022, 7, 1, 0, 0, 0).time()
    );
}
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_year().time(), 
        hj::date_time(2024, 1, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).next_year(2).time(), 
        hj::date_time(2025, 1, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 6, 15, 12, 30, 45).next_year().time(),
        hj::date_time(2024, 1, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 6, 15).next_year(3).time(),
...
{
    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_year().time(), 
        hj::date_time(2022, 1, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 2, 1, 12, 1, 1).pre_year(2).time(), 
        hj::date_time(2021, 1, 1, 0, 0, 0).time()
    );

    ASSERT_EQ(
        hj::date_time(2023, 6, 15, 12, 30, 45).pre_year().time(),
        hj::date_time(2022, 1, 1, 0, 0, 0).time()
    );
    
    ASSERT_EQ(
        hj::date_time(2023, 6, 15).pre_year(2).time(),
        hj::date_time(2021, 1, 1, 0, 0, 0).time()
    );
}