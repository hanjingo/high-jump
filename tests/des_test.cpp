...
TEST(des, encrypt)
{
    ...
    str_dst.clear();
    str_src = "hello world";
    ASSERT_TRUE(hj::des::encrypt(str_dst,
                                 str_src,
                                 key,
                                 hj::des::mode::ecb,
                                 hj::des::padding::pkcs5));
    ...
    str_dst.clear();
    str_src = "hello world 12345";
    ASSERT_FALSE(hj::des::encrypt(str_dst,
                                  str_src,
                                  key,
                                  hj::des::mode::ecb,
                                  hj::des::padding::no_padding));
...
TEST(des, decrypt)
{
    ...
    ASSERT_TRUE(hj::des::decrypt(str_dst,
                                 str_src,
                                 key,
                                 hj::des::mode::ecb,
                                 hj::des::padding::pkcs5));
...
TEST(des, encrypt_file)
{
    ...
    ASSERT_TRUE(hj::des::encrypt_file(str_dst,
                                      str_src,
                                      key,
                                      hj::des::mode::ecb,
                                      hj::des::padding::pkcs5));
    ...
    ASSERT_EQ(hj::des::encrypt_file(str_dst,
                                    str_src_nopadding,
                                    key,
                                    hj::des::mode::cbc,
                                    hj::des::padding::no_padding,
...
TEST(des, decrypt_file)
{
    ...
    ASSERT_TRUE(hj::des::encrypt_file(str_src,
                                      "./crypto.log",
                                      key,
                                      hj::des::mode::ecb,
                                      hj::des::padding::pkcs5));

    ASSERT_TRUE(hj::des::decrypt_file(str_dst,
                                      str_src,
                                      key,
                                      hj::des::mode::ecb,
                                      hj::des::padding::pkcs5));
    ...
    ASSERT_EQ(hj::des::decrypt_file(str_dst,
                                    str_src,
                                    key,
                                    hj::des::mode::ecb,
                                    hj::des::padding::pkcs7),
