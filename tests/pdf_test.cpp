...
TEST(pdf, show_text_at)
{
    ...
    page.set_font(hj::pdf::font_name::helvetica, 12);
    page.begin_text();
    EXPECT_NO_THROW(page.show_text_at("Hello, PDF!", hj::pdf::point(100.0f, 200.0f)));
    page.end_text();
}
...
TEST(pdf, draw_rectangle)
{
    hj::pdf::document doc;
    auto& page = doc.add_page();
    EXPECT_NO_THROW(page.draw_rectangle(hj::pdf::rectangle(100.0f, 200.0f, 50.0f, 30.0f), true));
}
...
TEST(pdf, draw_circle)
{
    hj::pdf::document doc;
    auto& page = doc.add_page();
    EXPECT_NO_THROW(page.draw_circle(hj::pdf::point(150.0f, 250.0f), 25.0f, true));
}
...
TEST(pdf, draw_line)
{
    hj::pdf::document doc;
    auto& page = doc.add_page();
    page.draw_line(hj::pdf::point(100.0f, 200.0f), hj::pdf::point(200.0f, 300.0f), true);
}
...
TEST(pdf, draw_text)
{
    ...
    page.set_font(hj::pdf::font_name::helvetica, 12);
    page.begin_text();
    EXPECT_NO_THROW(page.draw_text("Hello, PDF!", hj::pdf::point(100.0f, 200.0f)));
    page.end_text();
}
